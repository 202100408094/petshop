<template>
    <div class="views-petlnformation-add">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        prop="title"
                        required
                        :rules="[{required:true, message:'请填写标题'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'insert', module:'petlnformation', col:'title', trigger:'blur'}]"
                    >
                    ...
                    <el-form-item label="发布人 " prop="publisher"> <el-input v-model="form.publisher" readonly style="width: 250px"></el-input> </el-form-item>
...
<script setup>
    ...
    import { usePetlnformationCreateForm, canPetlnformationInsert } from "@/module";
    ...
    const { form } = usePetlnformationCreateForm();
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canPetlnformationInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {
